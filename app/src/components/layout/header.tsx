...
export default function Header() {
  ...
  return <header className="sticky top-0 z-40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80">
    ...
    <div className="flex h-14 w-full items-center gap-6 px-4 sm:px-6 lg:px-8">
      <Link href="/" aria-label="Zen — accueil" className="flex shrink-0 items-center gap-2 rounded-md focus-visible:outline-2 focus-visible:outline-ring"><Image src="/icons/favicon.png" alt="" width={24} height={24} /><span className="text-sm font-semibold tracking-tight">Zen</span></Link>
